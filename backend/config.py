...
class Config:
    # URL do frontend
    FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://vidashield.vercel.app')

    # Configurações do Auth0
    AUTH0_DOMAIN = os.getenv('AUTH0_DOMAIN', 'dev-xxxxxxxx.us.auth0.com')
    AUTH0_AUDIENCE = os.getenv('AUTH0_AUDIENCE', 'https://vidashield.onrender.com/api')
    AUTH0_CLIENT_ID = os.getenv('AUTH0_CLIENT_ID', '')
    AUTH0_CLIENT_SECRET = os.getenv('AUTH0_CLIENT_SECRET', '')
    AUTH0_CALLBACK_URL = os.getenv('AUTH0_CALLBACK_URL', 'https://vidashield.vercel.app/auth/callback')
    ...
    GOOGLE_REDIRECT_URI = os.getenv('GOOGLE_REDIRECT_URI', 'https://vidashield.onrender.com/api/auth/google/callback')
    GITHUB_REDIRECT_URI = 'https://vidashield.onrender.com/api/auth/github/callback'
    ...
    # hCaptcha
    HCAPTCHA_SITE_KEY = os.getenv('HCAPTCHA_SITE_KEY', '866663ec-b850-4a54-8884-8376d11051c4')
    ...
    def __init__(self):
        ...
        if not os.getenv('AUTH0_DOMAIN') or not os.getenv('AUTH0_AUDIENCE'):
            logging.warning("⚠️ Configurações do Auth0 não encontradas. Usando valores padrão para testes.")
