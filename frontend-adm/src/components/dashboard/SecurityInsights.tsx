...
const SecurityInsights = ({ insights }: SecurityInsightsProps) => {
  return (
    <div className="card-dark p-3 sm:p-4 shadow-glow-soft relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        {insights.map((insight, index) => (
          <div 
            key={index} 
            className={`p-3 sm:p-4 bg-zinc-800/80 backdrop-blur-sm rounded-lg border-l-4 shadow-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(0,255,153,0.2)] hover:translate-x-0.5 hover:-translate-y-0.5 ${
